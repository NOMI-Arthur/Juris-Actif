...
<head>
    ...
    <title>Publication de document</title>
</head>
<body>
     ...
     <div class="admin-wrapper">
        ...
        <!-- admin Content -->
            <div class="admin-content">
               ...
               <div class="content">
                    <h2 class="page-title">Ajouter des Documents</h2>
                    ...
                    <form action="documents.php" method="post" enctype="multipart/form-data">
                       ...
                       <div>
                            ...
                            <br>
                            <textarea name="body" id="editor1" value="<?php echo $body; ?>"></textarea>
                        </div>
                         <p>
                              <label>Importer la publication (.pdf)</label>
                              <p>
                              <input type="file" name="nomDoc" class="text-input" accept=".pdf">
                              </p>
                         </p>
                         ...
                         <div>
                            <button type="submit" name="AjouterDocument" class="btn btn-big">Ajouter le sujet</button>
                         </div>
                    </form>
